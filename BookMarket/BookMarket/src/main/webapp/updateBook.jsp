...
<div class="container py-4">
	...
	<%
		...
		ResultSet rs=null;
		String sql="SELECT * FROM bookmarket WHERE b_id=?";
	...
	<div class="row align-items-md-stretch">
		<div class="col-md-5">
			<img src="https://210.119.103.168:8080/uploads/kjj123000/<%=rs.getString("b_filename") %>" alt="image" style="width: 100%" />
		</div>
		<div class="col-md-7">
			<form name="newBook" action="./processUpdateBook.jsp" method="post" enctype="multipart/form-data">
				<div class="mb-3 row">
					...
					<div class="col-sm-5">
						<input type="text" name="bookId" id="bookId" class="form-control" value='<%=rs.getString("b_bookId") %>'>
					</div>
				</div>
				<div class="mb-3 row">

...
<body>
	...
	%>
		...
		<form action="Send.do" method="post">
        	...
        	<div class="form-group row">
            	<label for="otherAccount" class="col-sm-2 col-form-label">보낼 계좌번호</label>
           		<div class="col-sm-3">
                	<input type="text" id="otherAccount" name="otherAccount" class="form-control" placeholder="보낼 계좌번호">
            	</div>
        	</div>

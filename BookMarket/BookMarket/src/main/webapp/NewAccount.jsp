...
<%@ page import="mvc.model.AccountDTO" %>
<%@ page import="mvc.model.AccountDAO" %>
...
<body>
	...
	%>
		...
		<form action="NewAccount.do" method="post">
			...
			<div class="form-group row">
				<label for="password_confirm" class="col-sm-2 col-form-label">비밀번호 확인</label>
				<div class="col-sm-3">
					<input type="text" id="password_confirm" name="password_confirm" class="form-control" placeholder="비밀번호 확인">
				</div>
			</div>
